...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCustomSkeletalMeshThumbnailRenderer_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "CustomSkeletalMeshThumbnailRenderer.h" },
		{ "ModuleRelativePath", "Public/CustomSkeletalMeshThumbnailRenderer.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UCustomSkeletalMeshThumbnailRenderer_Statics::StaticCppClassTypeInfo = {
	...
	struct Z_CompiledInDeferFile_FID_Recordings_PackagedThjumbnailToTexture_Newer_005_ThumbnailToTextureTool_HostProject_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_CustomSkeletalMeshThumbnailRenderer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Recordings_PackagedThjumbnailToTexture_Newer_005_ThumbnailToTextureTool_HostProject_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_CustomSkeletalMeshThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCustomSkeletalMeshThumbnailRenderer, UCustomSkeletalMeshThumbnailRenderer::StaticClass, TEXT("UCustomSkeletalMeshThumbnailRenderer"), &Z_Registration_Info_UClass_UCustomSkeletalMeshThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCustomSkeletalMeshThumbnailRenderer), 2360529506U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Recordings_PackagedThjumbnailToTexture_Newer_005_ThumbnailToTextureTool_HostProject_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_CustomSkeletalMeshThumbnailRenderer_h_1566717480(TEXT("/Script/ThumbnailToTextureTool"),
		Z_CompiledInDeferFile_FID_Recordings_PackagedThjumbnailToTexture_Newer_005_ThumbnailToTextureTool_HostProject_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_CustomSkeletalMeshThumbnailRenderer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Recordings_PackagedThjumbnailToTexture_Newer_005_ThumbnailToTextureTool_HostProject_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_CustomSkeletalMeshThumbnailRenderer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
